...
Pretrained on Fineweb-edu (~50b tokens)
Finetuned on Smol-Smoltalk (from Hugging Face)

Here is the best model so far (1b parameters):
(https://drive.google.com/file/d/1TbqAKYpMgc2gJ0ogDHl6G8D0aoyv4Gds/view?usp=sharing)
